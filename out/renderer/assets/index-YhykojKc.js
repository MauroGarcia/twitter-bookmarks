...
function Sidebar({ onImport }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "w-64 bg-gray-50 border-r border-gray-200 p-4 flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-semibold text-gray-900 mb-3", children: [
      "Tags (",
      tags.length,
      ")"
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: `w-full text-left px-3 py-2 rounded-lg transition-colors ${selectedTag === null ? "bg-twitter text-white" : "text-gray-700 hover:bg-gray-200"}`,
          children: "Todos os bookmarks"
        }
      ),
      tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: `w-full text-left px-3 py-2 rounded-lg transition-colors ${selectedTag === tag.name ? "bg-twitter text-white" : "text-gray-700 hover:bg-gray-200"}`,
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1", children: tag.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500", children: tag.count })
          ] })
        },
        tag.id
      ))
...
function TagBadge({ tag, removable = false, onRemove }) {
...
function BookmarkCard({ bookmark, tags = [], onClick }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      onClick,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 mb-3", children: [
          bookmark.author_avatar_url && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-gray-900", children: bookmark.author_name }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-800 text-sm mb-3 line-clamp-3", children: bookmark.full_text }),
        tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 mb-3 flex-wrap", children: tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(TagBadge, { tag }, tag.id)) }),
...
function BookmarkList({ onSelectBookmark }) {
  ...
  if (bookmarks.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-8 text-gray-500", children: "Nenhum bookmark encontrado" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: bookmarks.map((bookmark) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    BookmarkCard,
    {
      bookmark,
...
function ImportDialog() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-lg p-6 max-w-sm w-full mx-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold", children: "Importar Bookmarks" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-gray-600 mb-6", children: [
      "Selecione o arquivo ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "bg-gray-100 px-2 py-1 rounded", children: "bookmarks.js" }),
      " da sua exportação do Twitter para importar todos os seus bookmarks salvos."
    ] }),
    message && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 p-3 bg-green-100 text-green-700 rounded-lg text-sm", children: message }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 p-3 bg-red-100 text-red-700 rounded-lg text-sm", children: error }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
...
function TagSelector({ selectedTagIds = [], onChange }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 max-h-48 overflow-y-auto", children: tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-3 p-2 hover:bg-gray-50 rounded cursor-pointer", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type: "checkbox",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 text-sm text-gray-900", children: tag.name })
    ] }, tag.id)) })
  ] });
}
function TweetDetail({ bookmark, tags = [], onClose }) {
  const [note, setNote] = reactExports.useState("");
  const [selectedTags, setSelectedTags] = reactExports.useState(tags.map((t) => t.id));
  const [isEditingNote, setIsEditingNote] = reactExports.useState(false);
  const [isEditingTags, setIsEditingTags] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-lg max-w-2xl w-full max-h-96 overflow-y-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-0 bg-white border-b border-gray-200 p-4 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold", children: "Detalhes do Bookmark" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: onClose,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-gray-200 pb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 mb-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-gray-900", children: bookmark.author_name }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-gray-500", children: [
              "@",
              bookmark.author_handle
            ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-800 mb-3", children: bookmark.full_text }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 text-sm text-gray-600", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "flex items-center gap-1 hover:text-twitter", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { size: 16 }),
            bookmark.like_count
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "flex items-center gap-1 hover:text-twitter", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-gray-900", children: "Tags" }),
          !isEditingTags && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
        ...
        isEditingTags ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TagSelector, { selectedTagIds: selectedTags, onChange: setSelectedTags }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Save, { size: 16, className: "inline mr-2" }),
                  "Salvar"
                ]
              }
            ),
          ...
          tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(TagBadge, { tag }, tag.id)),
          tags.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm", children: "Nenhuma tag" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-gray-900", children: "Notas Pessoais" }),
          !isEditingNote && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
        ...
        isEditingNote ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "textarea",
            {
              value: note,
        ...
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gray-50 p-3 rounded-lg min-h-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-700 text-sm whitespace-pre-wrap", children: note || /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400 italic", children: "Nenhuma nota" }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen bg-gray-100", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, { onImport: () => setImportDialog(true) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 flex flex-col overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 bg-white border-b border-gray-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SearchBar, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookmarkList, { onSelectBookmark: handleSelectBookmark }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ImportDialog, {}),
    selectedBookmark && /* @__PURE__ */ jsxRuntimeExports.jsx(
      TweetDetail,
      {
