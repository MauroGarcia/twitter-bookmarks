    ...
    <section className="space-y-10">
      ...
      <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_300px]">
        ...
        <aside className="rounded-layout border border-outline-variant/10 bg-surface-container p-6 shadow-cyan">
          <p className="font-label text-xs font-semibold uppercase tracking-[0.32em] text-secondary/80">Reading Pulse</p>
          <div className="mt-5 space-y-5">
            ...
            <div className="rounded-layout bg-surface-container-high p-5">
              ...
              <p className="mt-2 text-sm text-on-surface-variant">sinal agregado de relevância social entre os itens em destaque.</p>
            </div>
