import { importBookmarks } from './src/main/twitter-importer.js'
import { initDb, getBookmarks, getAllTags, getStats } from './src/main/db.js'
...
async function test() {
  ...
  try {
    ...
    const filePath = path.join(process.cwd(), 'test-bookmarks.js')
